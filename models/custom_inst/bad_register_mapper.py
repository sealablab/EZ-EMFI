...
with the Pydantic-based CustomInstApp system for YAML configuration and
...
- Integration with CustomInstApp (backward compatibility)
...
class BADRegisterMapper(BaseModel):
    ...
    enabling YAML-based configuration and integration with CustomInstApp.
    ...
    def to_app_registers(self) -> List[AppRegister]:
        ...
        CustomInstApp deployment workflows.
        ...
        for mapping in mappings:
            ...
            from .app_register import RegisterType
