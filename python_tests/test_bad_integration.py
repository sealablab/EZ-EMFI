...
from tools.generate_custom_inst_v2 import (
    load_yaml_spec,
...
from basic_app_datatypes import BasicAppDataTypes, RegisterMapper, TYPE_REGISTRY
...
"""
        ...
        output_dir.mkdir()
        template_dir = project_root / "shared" / "custom_inst" / "templates"
